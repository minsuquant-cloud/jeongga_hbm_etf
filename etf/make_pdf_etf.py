...
A(grid(["관문", "질문", "실측 결과", "판정"],
       [["① 추적오차", "지수를 얼마나 따라가나",
        ...
        ["③ CU 설계", "설정단위 정수화 괴리는",
         "1CU=20억 · 총괴리 6.3bp · 가격 교란에도 15bp 이내",
...
A(box([(BODY, "이 다섯 숫자의 공통점: <b>전부 실제 데이터로 계산했고, 코드와 테스트"
              "(145건)로 재현된다.</b> 희망 섞인 추정이 아니라 지금 시장 기준의 실측이다."),
       (SMALL, "① 가격 1년(2025-07~2026-07, FDR) · ② 거래대금 60거래일 · ③④ 2026-07-24~25 기준 · "

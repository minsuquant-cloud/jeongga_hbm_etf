...
**1차 판정 (SEC 4종, 근거: `docs/글로벌실사_판정근거_20260729.md`)** —
MU **편입**(앵커, 규칙 0) · CAMT **관찰**(20-F에 "AI향 50%"뿐, HBM 단독 % 미공시
— 심텍·SFA와 같은 잣대) · TSM **제외**(HBM 언급 0회, 매출분해 Wafer/Others 2줄) ·
ONTO **제외**(HBM 언급 0회 + 보고 세그먼트 1개). 글로벌판 **13종목·앵커 3사**
(삼성 14.54/MU 13.04/하이닉스 12.42) — **R3 20% WARN 해소**(최대비중 한미 18.00%),
순도 29.81%, 비앵커 10종 비중 불변(40/60 버킷 분리 실증). EDINET·HKEX·BESI 4종은
수동 실사 대기.
